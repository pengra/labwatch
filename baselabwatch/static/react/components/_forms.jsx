class Form extends React.Component {
  // props:
    ...
    // ajax : use ajax? default assumes true.
  ...
  constructor() {
    ...
    this.formSubmissionButton = this.formSubmissionButton.bind(this);
  }
  ...
  // rendering
  render() {
    return (<form onSubmit={this.handleSubmit} className="ajax-form">
      {this.state.form}
    </form>)
  }
}
