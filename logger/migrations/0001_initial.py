# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-09-17 21:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('sign_in_mode', models.CharField(choices=[('CARD', 'Card Scan'), ('NAME', 'Name input'), ('EMAL', 'Email'), ('NICK', 'Nickname input'), ('ADMI', 'Admin input')], max_length=3)),
                ('sign_out_mode', models.CharField(choices=[('CARD', 'Card Scan'), ('NAME', 'Name input'), ('EMAL', 'Email'), ('NICK', 'Nickname input'), ('ADMI', 'Admin input')], max_length=3)),
